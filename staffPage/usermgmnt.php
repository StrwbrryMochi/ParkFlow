      ...
      <nav>
        ...
        <div class="right">
          ...
          <button  onclick="openProfile()" class="user" id="userBtn">
            <img src="img/newjeans hanni icon ✦ ۰ —ᣞ.jpg" alt="User PFP" class="user-image" />
          </button>
        </div>
      </nav>
    ...
    <div class="notif-items">
      ...
      <div class="profile-modal">
        <div class="pModal-content">
          <img src="img/newjeans hanni icon ✦ ۰ —ᣞ.jpg" alt="">
          <div class="profile-details">
            <p class="profile-name">Hanni Pham</p>
            <div class="profile-info">
              <span class="profile-dot"></span>
              <span class="profile-id">90198329</span>
            </div>
          </div>
        </div>
        ...
        <div class="modalBtn">
          <ul>
            ...
            <li><a href="#"><i class="fa-solid fa-arrow-right-from-bracket"></i><span>Log Out</span></a></li>
          </ul>
        </div>
      </div>
...
<div class="table-container">
    ...
    <script src="highlighted.js"></script>
  </body>
</html>
